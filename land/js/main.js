...
(function ($) {
  ...
  $(".js #subscribe").waypoint(
    function () {
      $('.js #subscribe input[type="email"]').addClass(
        "animated fadeInLeftBig show"
      );
      $('.js #subscribe input[type="submit"]').addClass(
        "animated fadeInRightBig show"
      );
    },
    { offset: "bottom-in-view" }
  );
  ...
  if ($("html").hasClass("cssanimations")) {
    var activityIndicatorOn = function () {
      ...
      closeButtonOn = function (instance) {
        $(
          '<a href="#" id="imagelightbox-close" title="close"><i class="fa fa fa-times"></i></a>'
        )
          .appendTo("body")
